...
#	while ( (now < next_sunrise)  and (now < next_sunset) ) :
	reading0 = ADC.read("AIN0")
#	reading1 = ADC.read("AIN1")
#	reading2 = ADC.read("AIN2")
#	reading3 = ADC.read("AIN3")
#	reading4 = ADC.read("AIN4")
#	reading5 = ADC.read("AIN5")
#	reading6 = ADC.read("AIN6")

	print "AIN0 %.2f" % reading0
#
